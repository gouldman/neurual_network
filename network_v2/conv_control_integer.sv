module conv_control_integer#(
    ...
    output logic [input_data_bits - 1:0] parallel_conv_result,
    output logic [$clog2(pic_size*pic_size/serial_to_parallel_coe) - 1:0] parallel_conv_result_addr,
    output logic parallel_conv_result_valid,
...
logic [$clog2(pic_size * pic_size / serial_to_parallel_coe) - 1:0] parallel_conv_result_addr_counter, parallel_conv_result_addr_counter_n;
logic [1:0] serial_to_parallel_conv_result_counter, serial_to_parallel_conv_result_counter_n;
logic [$clog2(pic_size / serial_to_parallel_coe) - 1:0] parallel_conv_result_counter, parallel_conv_result_counter_n;
...
logic parallel_conv_result_valid_reg, parallel_conv_result_valid_reg_n;
logic [input_data_bits - 1:0] parallel_conv_result_reg, parallel_conv_result_reg_n;
...
always_comb begin
    ...
    if(pe_result_valid) begin
        if(parallel_conv_result_counter == pic_size - 1) begin
            parallel_conv_result_counter_n = 0; 
        end else begin
            parallel_conv_result_counter_n = parallel_conv_result_counter + 1;
        end
...
assign parallel_conv_result_addr = parallel_conv_result_addr_counter;
...
always_ff @(posedge clk or negedge rst_n) begin
    if(!rst_n) begin
        ...
        parallel_conv_result_valid_reg <= 0;
        parallel_conv_result_reg <= 0;
    end else begin
        ...
        parallel_conv_result_valid_reg <= parallel_conv_result_valid_reg_n;
        parallel_conv_result_reg <= parallel_conv_result_reg_n;        
    end
end
...
always_comb begin
    ...
    parallel_conv_result_valid_reg_n = 1'b0;
    parallel_conv_result_reg_n = parallel_conv_result_reg;
...
assign parallel_conv_result = parallel_conv_result_reg;
assign parallel_conv_result_valid = parallel_conv_result_valid_reg;
assign read_previous_result_enable = read_previous_result_enable_reg;
assign conv_result = pe_result + previous_result_buffer[parallel_conv_result_counter];
